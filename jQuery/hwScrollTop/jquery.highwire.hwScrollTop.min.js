 ...
 */
(function($){$.fn.hwScrollTop=function(params){var settings=$.extend({},{anchor:'#',position:'left',startscroll:400,bordercolor:'#000',borderwidth:'1px',borderstyle:'solid',backgroundcolor:'#000',color:'#fff',fontsize:'14px',paddingtop:'5px',paddingbottom:'5px',paddingleft:'10px',paddingright:'10px',text:'Top'},params);var htmlcode="<a  id='hwScrollBox' href='"+settings.anchor+"' style='display:block;position:fixed;bottom:0;"+settings.position+":0;border-color: "+settings.bordercolor+";border-width:"+settings.borderwidth+";border-style:"+settings.borderstyle+";background-color: "+settings.backgroundcolor+";color: "+settings.color+";font-size: "+settings.fontsize+";padding-top: "+settings.paddingtop+";padding-bottom: "+settings.paddingbottom+";padding-left: "+settings.paddingleft+";padding-right: "+settings.paddingright+";display: none;' >"+settings.text+"</a>";$(this).append(htmlcode);$(window).scroll(function(){if($(window).scrollTop()<=settings.startscroll){$('#hwScrollBox').fadeOut();}
else{$('#hwScrollBox').slideDown();}});};})(jQuery);